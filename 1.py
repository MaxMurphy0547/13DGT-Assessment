...
def score_message(msg, text_colour):
    txt = font.render(msg, True, text_colour)
    text_box = txt.get_rect(center=(130, 50))
    screen.blit(txt, text_box)
...
def death_message(msg, text_colour):
    ...
    text_box = txt.get_rect(center=(325, 300))
    screen.blit(txt, text_box)
def play_again_message(msg, text_colour):
    txt = death_other_font.render(msg, True, text_colour)
    text_box = txt.get_rect(center=(325, 440))
    screen.blit(txt, text_box)
def compare_scores_message(msg, text_colour):
    txt = death_other_font.render(msg, True, text_colour)
...
def game_loop():
    ...
    screen.fill (black)
    death_message("You died", white)
    compare_scores_message("your score was " + str(score) + " your high score is " + str(high_score), white)
    play_again_message("Press R to Play Again Or Q To Quit", white)
    pygame.display.update()
